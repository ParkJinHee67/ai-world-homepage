      ...
      <section className="container-max" style={styles.headerSection}>
        <div className="websites-header-flex" style={styles.headerFlexContainer}>
          <div style={styles.headerInner}>
            ...
            <h1 className="websites-title" style={styles.title}>홈페이지 포트폴리오</h1>
...
if (typeof document !== 'undefined') {
  ...
  style.textContent = `
    ...
    .websites-header-canvas {
      animation: floatWebImage 6s ease-in-out infinite;
      transition: all 0.5s ease;
    }
    .websites-header-canvas:hover {
      transform: scale(1.02);
    }
    @media (max-width: 768px) {
      .websites-header-flex {
      ...
      .websites-header-flex > div {
        text-align: center !important;
        display: flex !important;
        flex-direction: column !important;
        align-items: center !important;
      }
      .websites-header-img-container {
        width: 100% !important;
