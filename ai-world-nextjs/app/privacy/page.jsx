    ...
    <div style={styles.pageWrapper}>
      <div className="container-max" style={styles.container}>
        ...
        <div style={styles.header}>
          ...
          <h1 style={styles.mainTitle}>개인정보처리방침</h1>
        ...
        <div className="glass-panel" style={styles.documentBody}>
          ...
          <div style={styles.section}>
            ...
            <div style={styles.contactInfo}>
              <p><strong>공식 문의 메일</strong>: <a href="mailto:jhpa670211@gmail.com" style={styles.link}>jhpa670211@gmail.com</a></p>
              <p><strong>공식 소통 채널</strong>: <a href="https://open.kakao.com/o/si1c9OAi" target="_blank" rel="noopener noreferrer" style={styles.link}>카카오 오픈채팅 일대일 채널</a></p>
            </div>
          </div>

          {/* Footer Info */}
          <div style={styles.docFooter}>
            <p>시행 일자: <strong>2026년 07월 13일</strong></p>
          </div>
