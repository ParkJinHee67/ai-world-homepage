...
const translations = {
  ko: {
    ...
    'card.intro_video': '소개영상',
    'card.intro_video_tooltip': '소개 영상 보기',
    'card.purchase': '구매방법',
    'card.purchase_tooltip': '구매 방법 안내',
    'card.launch_tooltip': '앱 실행하기',
    'card.manual_tooltip': '노션 가이드 및 매뉴얼 보기',
    'card.share_tooltip': '공유 링크 복사',
    'purchase.kicker': '구매 안내',
    'purchase.includes': '포함 내용',
    'purchase.how': '구매 방법',
    'purchase.account': '입금 계좌',
    'purchase.copy': '계좌 복사',
    'purchase.copied': '복사됨',
    'purchase.mail': '구매 메일 보내기',
    'purchase.detail': '자세한 상품 소개',
    'purchase.open_site': '사이트에서 이용·구매',
  ...
  en: {
    ...
    'card.intro_video': 'Intro Video',
    'card.intro_video_tooltip': 'Watch intro video',
    'card.purchase': 'How to Buy',
    'card.purchase_tooltip': 'Purchase guide',
    'card.launch_tooltip': 'Launch the app',
    'card.manual_tooltip': 'Open Notion guide / manual',
    'card.share_tooltip': 'Copy share link',
    'purchase.kicker': 'Purchase Guide',
    'purchase.includes': 'What\'s included',
    'purchase.how': 'How to purchase',
    'purchase.account': 'Bank account',
    'purchase.copy': 'Copy account',
    'purchase.copied': 'Copied',
    'purchase.mail': 'Email to purchase',
    'purchase.detail': 'Product details',
    'purchase.open_site': 'Open site to use / buy',
